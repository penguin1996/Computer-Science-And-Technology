...
public class DataSourceConfig {
     ...
     * 数据库信息查询
     */
    private com.baomidou.mybatisplus.generator.config.IDbQuery dbQuery;
    /**
     * schemaName
     */
     ...
     * 类型转换
     */
    private com.baomidou.mybatisplus.generator.config.ITypeConvert typeConvert;
    /**
     * 关键字处理器
     *
     * @since 3.3.2
    ...
    @NotNull
    public com.baomidou.mybatisplus.generator.config.IDbQuery getDbQuery() {
        if (null == dbQuery) {
    ...
    @NotNull
    public com.baomidou.mybatisplus.generator.config.ITypeConvert getTypeConvert() {
        if (null == typeConvert) {
            DbType dbType = getDbType();
            // 默认 MYSQL
