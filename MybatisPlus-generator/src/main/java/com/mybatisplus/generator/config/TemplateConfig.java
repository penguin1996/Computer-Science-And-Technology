...
public class TemplateConfig {
    ...
    private TemplateConfig() {
        this.controller = com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_CONTROLLER;
        this.entity = com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_ENTITY_JAVA;
        this.entityKt = com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_ENTITY_KT;
        this.xml = com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_XML;
        this.service = com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_SERVICE;
        this.serviceImpl = com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_SERVICE_IMPL;
        this.mapper = com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_MAPPER;
    }
    ...
    public String getEntity(boolean kotlin) {
        if (!this.disableEntity) {
            if (kotlin) {
                return StringUtils.isBlank(this.entityKt) ? com.baomidou.mybatisplus.generator.config.ConstVal.TEMPLATE_ENTITY_KT : this.entityKt;
            }
