...
public class PackageConfig {
    ...
    public Map<String, String> getPackageInfo() {
        if (packageInfo.isEmpty()) {
            packageInfo.put(com.baomidou.mybatisplus.generator.config.ConstVal.MODULE_NAME, this.getModuleName());
            packageInfo.put(com.baomidou.mybatisplus.generator.config.ConstVal.ENTITY, this.joinPackage(this.getEntity()));
            packageInfo.put(com.baomidou.mybatisplus.generator.config.ConstVal.MAPPER, this.joinPackage(this.getMapper()));
            packageInfo.put(com.baomidou.mybatisplus.generator.config.ConstVal.XML, this.joinPackage(this.getXml()));
            packageInfo.put(com.baomidou.mybatisplus.generator.config.ConstVal.SERVICE, this.joinPackage(this.getService()));
            packageInfo.put(com.baomidou.mybatisplus.generator.config.ConstVal.SERVICE_IMPL, this.joinPackage(this.getServiceImpl()));
            packageInfo.put(com.baomidou.mybatisplus.generator.config.ConstVal.CONTROLLER, this.joinPackage(this.getController()));
