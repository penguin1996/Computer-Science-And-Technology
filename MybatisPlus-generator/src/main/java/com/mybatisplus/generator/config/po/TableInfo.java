 ...
 * the License.
 */
package com.mybatisplus.generator.config.po;
...
public class TableInfo {
    ...
    private final List<com.baomidou.mybatisplus.generator.config.po.TableField> fields = new ArrayList<>();
    private boolean havePrimaryKey;
    /**
     * 公共字段
     */
    private final List<com.baomidou.mybatisplus.generator.config.po.TableField> commonFields = new ArrayList<>();
     ...
     * @since 3.5.0
     */
    public void addField(@NotNull com.baomidou.mybatisplus.generator.config.po.TableField field) {
    ...
    public String getFieldNames() {
        ...
        if (StringUtils.isBlank(fieldNames)) {
            this.fieldNames = this.fields.stream().map(com.baomidou.mybatisplus.generator.config.po.TableField::getColumnName).collect(Collectors.joining(", "));
        }
    ...
    @NotNull
    public List<com.baomidou.mybatisplus.generator.config.po.TableField> getFields() {
        return fields;
    }
    ...
    @NotNull
    public List<com.baomidou.mybatisplus.generator.config.po.TableField> getCommonFields() {
        return commonFields;
    }
}
